            ...
            <div class="row">
                <div class="col-12 tm-site-header-col">
                    <div class="tm-site-header-left">
                        <img class="tm-site-name" src="img/logo/logo4.png" alt="">
                    </div>
                        ...
                        <nav class="navbar navbar-expand-lg">
                          ...
                          <div class="collapse navbar-collapse tm-nav" id="navbarSupportedContent1">
                            ...
                            <ul class="navbar-nav mr-auto">
                              <li class="nav-item <?= active("/epiWeb/index.php"); ?>">
                                <a class="nav-link tm-nav-link" href="index.php">Accueil <span class="sr-only">(current)</span></a>
                              </li>
                              <li class="nav-item <?php active("/epiWeb/company.php"); ?>">
                                <a class="nav-link tm-nav-link" href="company.php">L'agence</a>
                              </li>
                              <li class="nav-item <?php active("/epiWeb/services.php"); ?>">
                                <a class="nav-link tm-nav-link" href="services.php">Services</a>
                              </li>
                              <li class="nav-item <?php active("/epiWeb/contact.php"); ?>">
